                ...
                {({ values, errors, touched, handleChange, handleBlur, handleSubmit, isSubmitting }) => (
                    <form className="payForm" onSubmit={handleSubmit}>
                        ...
                        <div className="cardData">
                            ...
                            <div className="inputSection inputSection_smallBottomMargin">
                            ...
                            <div className="cardData__lnLineSectionWrap">
                                <div className="inputSection inputSection_shotWidth">
                                    ...
                                    <div onClick={this.onShowHint} tabindex="0" onBlur={this.onShowHint}
                                        className={this.state.hintShowing ?
                                             "hint hint_active" : "hint"}>
                                        <span>?</span>
                                        <div className={this.state.hintShowing ?
                                            "hint__info hint__info_showData" : "hint__info"}>
                                                <span>Срок действия вашей карты написан на лицевой стороне карты.
                                                         Запишите срок дейсвия в формате Месяц / 2 последние цифры года.
                                                </span>
                                        </div>
                                    </div>
                                </div>
                                <div className="inputSection inputSection_shotWidth">
                                    ...
                                    <div onClick={this.showCardHint} tabindex="0" onBlur={this.showCardHint}
                                         className={this.state.cardHintShowing ?
                                             "hint hint_active" : "hint"}>
                                        <span>?</span>
                                        <div
                                            className={this.state.cardHintShowing ?
                                                'hint__info hint__info_elsePosition' : 'hint__info'}>
                            ...
                            <div className="agreement">
                                <span>Нажимая кнопку "Оплатить",
                                  Вы соглашаетесь на обработку данных в соответствии с
